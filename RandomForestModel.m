classdef RandomForestModel < handle & modelToolkit
    ...
    methods
        function obj = RandomForestModel(kfold, penaltyList,  thresholdList, discription)
            obj.KFOLD = kfold;
        ...
        function model = trainModelandRecord(obj, trainData, Featureset, curFold)
            template = templateTree('NumPredictorsToSample','all',...
