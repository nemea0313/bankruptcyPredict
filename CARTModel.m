classdef CARTModel < handle & modelToolkit
    ...
    methods
        function obj = CARTModel(kfold, penaltyList,  thresholdList, discription)
            obj.KFOLD = kfold;
        ...
        function model = trainModelandRecord(obj, trainData, FeatureSet, curFold)
            ...
            model = fitctree(trainData(:, FeatureSet), trainData(:,1),'OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct( 'ShowPlots', 0));
